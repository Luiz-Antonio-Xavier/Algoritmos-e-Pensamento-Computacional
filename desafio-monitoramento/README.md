...
9. Exibe um **relatório final** com os resultados.
...
Utilizado para realizar o monitoramento das temperaturas, mantendo o programa em execução até que o usuário encerre ou sejam identificadas três temperaturas consecutivas acima do limite.
...
Foram inseridos valores inválidos para verificar o funcionamento das validações.

**Resultado:** o programa rejeita os valores inválidos e solicita uma nova entrada.
...
**Resultado:** o contador de temperaturas consecutivas é reiniciado quando uma temperatura fica dentro do limite, mantendo o monitoramento ativo.
...
Escolhi utilizar uma combinação de `do...while` e `while` porque cada estrutura se adapta melhor a uma parte do programa.

O `do...while` foi utilizado na validação do limite de temperatura, pois o usuário precisa informar o valor pelo menos uma vez antes que ele seja verificado.

Já o `while` foi utilizado no monitoramento, permitindo que várias temperaturas sejam registradas até que o usuário encerre o programa ou sejam identificadas três temperaturas consecutivas acima do limite.

A diferença entre testar a condição antes ou depois da execução foi importante principalmente na validação do limite, pois o valor precisa ser informado antes de ser verificado.
